---
description: 'Technology-agnostic blueprint generator for creating comprehensive claude.md files that guide claude to produce code consistent with project standards, architecture patterns, and exact technology versions by analyzing existing codebase patterns and avoiding assumptions.'
mode: 'agent'
---
...
"Generate a comprehensive claude.md file that will guide claude to produce code consistent with our project's standards, architecture, and technology versions. The instructions must be strictly based on actual code patterns in our codebase and avoid making any assumptions. Follow this approach:
...
To create the claude.md file, first analyze the codebase to:
...
A comprehensive claude.md file that will guide claude to produce code that is perfectly compatible with your existing technology versions and follows your established patterns and architecture.