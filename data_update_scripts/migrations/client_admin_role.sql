-- =======================================
-- Client Admin Role Setup for RSVP4
-- Date: 2025-07-30
-- =======================================
...
SELECT 
    (SELECT role_id FROM roles_master WHERE name = 'Client Admin'),
    permission_id
...
WHERE name IN (
    ...
    'venue_event_allocation_crud'
);

-- Assign sub-event management permissions
INSERT OR IGNORE INTO role_permissions_tx (role_id, permission_id)
SELECT 
    (SELECT role_id FROM roles_master WHERE name = 'Client Admin'),
    permission_id
